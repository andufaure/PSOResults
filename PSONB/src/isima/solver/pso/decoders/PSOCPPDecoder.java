 ...
 * @author onio
 */
public class PSOCPPDecoder implements PSOPositionDecoder {
    ...
    public PSOCPPDecoder(Criterion inCriterion) throws Exception
    {
    ...
    public PSOPositionDecoder buildCopy() throws Exception {
        return new PSOCPPDecoder(this.criterion);
    }
