...
public class Main {
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            System.out.println("DecodingPolicy:CPP");
            System.out.println("MutationPolicy:Null");
            System.out.println("ParticleNeighborhood:DynamicGeneralizedEuclideanDistance");
